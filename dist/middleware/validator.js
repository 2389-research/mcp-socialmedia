...
export class RequestValidator {
    ...
    async validateRequest(request) {
        ...
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                validationError.code = -32602; // Invalid params
                validationError.data = error.errors;
    ...
    async validateResponse(response, method) {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                validationError.code = -32603; // Internal error
                validationError.data = error.errors;
                throw validationError;
            }
            throw error;
     ...
     */
    async performCustomValidations(request) {
